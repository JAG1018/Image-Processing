...
def use_warp_maps(origins, targets, fps, steps):
    ...
    video = cv2.VideoWriter('/home/hpc-lavasa/Desktop/Avastha_Research-20221126T174731Z-001/Avastha_Research/DiffMorph-master/morph/morph.mp4', fourcc, fps, (ORIG_WIDTH, ORIG_HEIGHT))
    ...
    cv2.imwrite("/home/hpc-lavasa/Desktop/Avastha_Research-20221126T174731Z-001/Avastha_Research/DiffMorph-master/morph/result.jpg", cv2.cvtColor(res_img, cv2.COLOR_RGB2BGR))
